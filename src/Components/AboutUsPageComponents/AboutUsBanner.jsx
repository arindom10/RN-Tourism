  ...
  return (
    <div className="container mx-auto space-y-12">
      <div className="text-center  py-16">
        ...
        <h1 className="text-6xl font-bold text-[#993128] mt-4">ABOUT US</h1>
        <div className="mt-8">
          <img
            className="w-full object-cover h-screen rounded-lg"
      ...
      <div className=" py-8">
        ...
        <h2 className="text-7xl font-semibold text-[#993128] mt-4">
      ...
      <div className="flex flex-wrap lg:flex-nowrap items-center px-6 py-12">
